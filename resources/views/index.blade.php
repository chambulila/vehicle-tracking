...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">VT SYSTEM</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a class="text-white nav-link" 
                ...
                <svg class="w-1 h-1" aria-hidden="true" fill="none"
                    stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    viewBox="0 0 24 24" stroke="currentColor" style="width: 30px;">
                    <path
  ...
  {{-- <footer class="main-footer">
    <strong>Copyright &copy; Chambulila <a href="https://adminlte.io">Design</a>.</strong>
    All rights reserved.
  </footer> --}}
